  ...
  return (
    <>
      ...
      <FlexColumn>
        ...
        <Paragraph>
          Your course form for 2021-2022 academic section has been submitted
          successfully{" "}
        </Paragraph>
   ...
   <tr style={{height:"70px"}}> 
     ...
     <div class='justify'> 
     <RectangleRoot>
      <p onClick={() => setShouldshow(true)} className='text-white pl-6 cursor-pointer'>Submit course form</p>   
    </RectangleRoot>
